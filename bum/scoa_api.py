...
def response_pega_scoa(id_msg, scoa_pega_url, pega_user, pega_password,project_id,coa_mapping,entity_object_id,business_entity_id):
    ...
    sorted_path_df = scoa_final_dataframe = pd.DataFrame()
    ...
    scoa_final_dataframe,response_dict,scoaDataFrame,sorted_path_df = main_scoa(coa_mapping,model,tokenizer) #,model,tokenizer
    ...
    if len(response_dict) != 0:
        ...
        if 'Error' in response_dict.keys():
            ...
            try:
                ...
                data = session.post(url=scoa_pega_url, data=payload,
...
class ProcessPega:
    ...
    def __init__(self, msg_id, scoa_pega_url, pega_user, pega_password,project_id,entity_object_id,business_entity_id):

        self.msg_id = msg_id
        self.scoa_pega_url = scoa_pega_url
    ...
    ''' 1. Calling black box class to check for presence of files
        ...
        3. In parallel sending response to pega if we have coa
    '''
    ...
    def get_fs_tb(self):
        ...
        try:
            ...
            bidding_cb = Process(target=response_pega_scoa,
                                 args=(self.msg_id, self.scoa_pega_url, self.pega_user, self.pega_password, self.project_id,self.coa_mapping,
                                       self.entity_object_id,self.business_entity_id))
            bidding_cb.start()
            ...
            if coa==None:
                print("coa path not present for project id {}, business entity id {}".format(self.project_id,self.business_entity_id))
                ...
                print("success payload executed of project id {}, business entity id {}".format(self.project_id,self.business_entity_id))
...
def scoa_call_pega_api(msg_id, scoa_pega_url, pega_user, pega_password,project_id,entity_object_id,business_entity_id):
    obj_call = ProcessPega(msg_id, scoa_pega_url, pega_user, pega_password,project_id,entity_object_id,business_entity_id)
